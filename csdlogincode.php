...
// }
    ...
    if($studentId_type['student_id'] == "aiti-kaceAdmin") 
    {
    ...
    {
        $_SESSION['student_id'] = $student_id;
        header('Location: CSD1.1/bismark_otu_v6f.php');
    }

    else if($studentId_type['student_id'] == "2020CSD1.1M019")
    {
        $_SESSION['student_id'] = $student_id;
        header('Location: CSD1.1/elvis_anning_r0n.php');
    }

    else if($studentId_type['student_id'] == "2020CSD1.1M011")
    {
        $_SESSION['student_id'] = $student_id;
        header('Location: CSD1.1/kelvin_agyapon_d9d.php');
    }

    else if($studentId_type['student_id'] == "2020CSD1.1M020")
    {
        $_SESSION['student_id'] = $student_id;
        header('Location: CSD1.1/richard_asante_s6i.php');
    }

    else if($studentId_type['student_id'] == "2020CSD1.1M015")
    {
        $_SESSION['student_id'] = $student_id;
        header('Location: CSD1.1/oscar_opoku_a5l.php');
    }
