...
if (isset($_POST['btn_pdf']))
 {
    ...
    //  $pdf->cell('20', '10', 'JAVASCRIPT', '1', '1', 'C');
    //  $pdf->cell('20', '10', 'DATABASE', '1', '0', 'C');
    //  $pdf->cell('20', '10', 'PYTHON', '1', '0', 'C');
    ...
    while ($row = mysqli_fetch_assoc($query_run)) 
    {
        ...
        // $pdf->cell('20', '10', $row['javascript'], '1', '1', 'C');
        // $pdf->cell('20', '10', $row['oracle_database'], '1', '0', 'C');
        // $pdf->cell('20', '10', $row['python'], '1', '0', 'C');
