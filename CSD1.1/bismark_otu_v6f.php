...
<!---------------PAGE CONTENT BEGINS-------------------->
 ...
 <!-- <form action="pdf_csd.php" method="POST">
       <button type="submit" name="btn_pdf" class="btn btn-primary float-right"><i class="fas fa-download fa-sm text-white-50"></i>Generate Report</button>
    </form> -->
    ...
    <div id="coll" class="collapse">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary text-center">WELCOME BISMARK OTU <br>THIS IS YOUR RESULTS</h6>
            </div>
