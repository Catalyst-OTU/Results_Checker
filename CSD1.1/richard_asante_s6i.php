    ...
    <div id="coll" class="collapse">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary text-center">WELCOME RICHARD ASANTE <br>THIS IS YOUR RESULTS</h6>
            </div>
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <div class="card-footer py-3">
                  ...
                  <h6 class="m-0 font-weight-bold text-success text-center">FAIL</h6>
